...
namespace PinkoCommon.Utility
{
    ...
    /// </summary>
    public interface IPinkoDictionary<TK, T>
    {
        ///// <summary>
        ...
        ///// <returns></returns>
        //T ReplaceCondition(TK key, Func<T, bool> conditionAction, Func<T, T> replacementAction);
        ...
        ///// </returns>
        //T Get(TK key, Func<T> itemFactory);
        ...
        ///// False: inserted items because it did not exists
        ///// </returns>
        //bool Update(TK key, Func<T> itemFactory);
    }
    ...
    /// Concurrent / thread safe Pinko dictionary
    /// </summary>
    public class PinkoDictionary<TK, T> : IPinkoDictionary<TK, T>
    {
        /// <summary>
        /// Replace keyed item  when condition is true. Done this way to assure atomic operation in dictionary.
        /// </summary>
        ...
        /// <summary>
        /// Update an item is key exists
        /// </summary>
        /// <param name="key"></param>
        /// <param name="itemFactory"></param>
        /// <returns>
        /// True: Item updated
        /// False: Items not found thus not updated
        /// </returns>
